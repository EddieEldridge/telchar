...
export const LAKEMAN: Culture = {
    ...
    description: `
      ...
      in long, tight tresses.
      When abroad they may be recognised by their gear, as they often carry equipment of superior make. 
    ...
    backgrounds: [
        ...
        `,
            skillProficiencies: ["Medicine", "Travel"],
        ...
        `,
            skillProficiencies: ["Hunting", "Nature"],
        ...
        `,
            skillProficiencies: ["Deception", "Riddle"],
